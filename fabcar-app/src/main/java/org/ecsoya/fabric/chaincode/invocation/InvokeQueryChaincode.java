 ...
 */
package org.ecsoya.fabric.chaincode.invocation;
...
public class InvokeQueryChaincode {
	...
	public static void main(String args[]) {
		try {
			...
			ChaincodeID ccid = ChaincodeID.newBuilder().setName(Config.CHAINCODE_1_NAME)
					.setVersion(Config.CHAINCODE_1_VERSION).build();
