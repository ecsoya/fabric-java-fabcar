package org.ecsoya.fabric.config;
...
public class Config {
	...
	public static final String CHANNEL_CONFIG_PATH = "src/main/resources/config/channel.tx";

	public static final String ORG1_USR_BASE_PATH = "src/main/resources/crypto-config" + File.separator
	...
	public static final String ORG2_USR_BASE_PATH = "src/main/resources/crypto-config" + File.separator
	...
	public static final String CHAINCODE_ROOT_DIR = "src/main/resources/chaincode";// "chaincode";
